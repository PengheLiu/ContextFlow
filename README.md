...
<p align="center">
  <b>阅读不该止于理解，更应成为下一次思考的上下文。</b><br>
  <sub>Capture how you understand. Reuse it wherever you think next.</sub><br>
...
ContextFlow 把这段理解过程结构化下来：原文、问题、答案、判断与总结，先进入
**你自己的笔记库**，再成为本地 agent 可以继续调用的长期上下文。

它不是又一个阅读器，也不是又一个聊天框。它是一层连接**阅读、个人知识与本地智能**的上下文基础设施。
...
| ❓ **解释** | 打开面板先看 200 字速览；选中一段，再问你想问的。可以交给本机 AI agent |
| 📝 **总结** | 读完写几句，和上面三类一起沉淀 |
...
一键同步。**一篇文章一个文档**，速览与四类阅读记录各有自己的标题：

```markdown
# Stealing Reasoning Traces from Proprietary LLM APIs

## 速览
这篇提出一种通过公开 API 反推模型推理痕迹的攻击，核心漏洞是加密推理块可跨会话复用。
